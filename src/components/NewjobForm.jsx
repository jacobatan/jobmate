  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="border-0 rounded-2xl shadow-2xl relative flex flex-col w-full my-auto h-auto xl:w-3/5 xl:h-auto 2xl:w-1/2 bg-white outline-none cursor-default p-8"
