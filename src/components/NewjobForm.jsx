  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="border-0 rounded-2xl shadow-2xl relative flex flex-col w-full sm:w-1/2 my-auto h-auto xl:w-2/5 xl:h-auto bg-white outline-none cursor-default p-8"
