...
const Summary = (props) => {
    const awaitingResponseRatio = 2/5;
    const offersRatio = 2/5; 
    return(
        //main summary div
        <div className='w-full mx-auto shadow-lg rounded-md transform transition-all bg-white md:max-w-screen-sm lg:max-w-screen-md sm:py-6 sm:flex items-center justify-between'>
            
            {/* stats*/}
            <div className=" flex flex-col text-center sm:w-2/5 sm:my-8 sm:ml-8 transform transition-all ">
                {/* total jobs */}
                ...
                <div className="flex text-sm leading-6 font-medium">
                    <div className={`bg-green-300  rounded-lg mr-1  py-2 w-2/5`}>5</div>
                    <div className={`bg-orange-300 rounded-lg py-2 w-3/5`}>3</div>
                </div>
            </div>
